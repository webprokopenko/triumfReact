...
class Transactions extends Component{
    ...
    render(){
        let amount_usd = (this.props.globalWallets[this.props.id].balance!=='...'? (this.props.curr[this.wallet.blockchain].usd * this.props.globalWallets[this.props.id].balance): '...');
        return(
            <TransactionsUI 
